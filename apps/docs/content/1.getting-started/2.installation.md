...
Add evlog as a Nitro plugin. The plugin path differs between Nitro v2 and v3:
...
Use the evlog error handler to properly serialize structured errors with all fields (`why`, `fix`, `link`) in the HTTP response:
